...
public class Correction_Tp3_exo2 {
    /** 
...
Clavier.lireInt(); System.out.println("Veuillez saisir le second nombre");
    ...
    public static int lePlusGrandDesDeux(int nombre1, int nombre2) {
        int resultat;
        if (nombre1 > nombre2) {resultat = nombre1;}
    ...
    public static int lePlusGrandDesDeuxbis(int nombre1, int nombre2) {
        ...
        int lePlusGrand;
        lePlusGrand = nombre2;
        if (nombre1 > nombre2) {lePlusGrand = nombre1;}
        return lePlusGrand;
    }
    ...
    public static int lePlusGrandDesQuatre(int nombre1, int nombre2, int nombre3, int nombre4) {
        ...
        if (nombre1 > nombre2) {lePlusGrand1 = nombre1;}
        if (nombre3 > nombre4) {lePlusGrand2 = nombre3;}
        lePlusGrand = lePlusGrand2;
        if (lePlusGrand1 > lePlusGrand2) {lePlusGrand = lePlusGrand1;}
        return lePlusGrand;
    }

    public static int lePlusGrandDesQuatrebis(int nombre1, int nombre2, int nombre3, int nombre4) {
        int lePlusGrand = nombre1;
        if (lePlusGrand < nombre2) {lePlusGrand = nombre2;}
        if (lePlusGrand < nombre3) {lePlusGrand = nombre3;}
        if (lePlusGrand < nombre4) {lePlusGrand = nombre4;}
        return lePlusGrand;
    }
    public static int lePlusGrandDesQuatreter(int nombre1, int nombre2, int nombre3, int nombre4) {
        ...
        if (nombre1 < nombre3) {nombre1 = nombre3;}
        if (nombre1 < nombre4) {nombre1 = nombre4;}
        return nombre1;
    }
}
